...
def run_all_experiments():
    ...
    experiments = [
        ...
        {"name": "One-Point Crossover", "overrides": {"crossover_method": "one_point"}},
        {"name": "Tournament Selection", "overrides": {"selection_method": "tournament"}},
        {"name": "Medium Mutation (15%)", "overrides": {"mutation_rate": 0.15}},
        {"name": "Small Population (50)", "overrides": {"population_size": 50}}
    ]
